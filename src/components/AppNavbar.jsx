...
import { Cog6ToothIcon ,UserGroupIcon ,UserIcon ,Squares2X2Icon, PaperAirplaneIcon, ArrowLeftOnRectangleIcon } from '@heroicons/react/24/outline'

function AppNavbar(props) {
  return (
    <div className=' fixed left-10  bottom-5  bg-black flex space-x-6 max-w-max p-4 px-6 rounded-full '>
         ...
         <ArrowLeftOnRectangleIcon onClick={props.fn} className=" hover:bg-lime-200 cursor-pointer p-2 hover:text-black  h-10 rounded-full text-gray-100" />
    </div>
  )
}
